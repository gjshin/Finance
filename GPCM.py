...
PYT.VI"""
    ...
    st.markdown("**Size Premium (한국공인회계사회 연구결과, 2026.06.05)**")
    ...
    with st.expander("📊 시가총액별 Size Premium 참고표"):
        ...
        |------|---------------------|--------------|
        | **Micro** | 296 ~ 2,583 | **4.02%** |
        | **Low** | 2,585 ~ 8,671 | 1.19% |
        | **Mid** | 8,679억 초과 | -0.45% |
        """)
        ...
        | 구분 | 시가총액 범위 (억원) | Size Premium |
        |------|---------------------|--------------|
        | **5분위 (최소)** | 296 ~ 1,759 | **4.86%** |
        | **4분위** | 1,760 ~ 3,135 | 2.67% |
        | **3분위** | 3,142 ~ 6,600 | 0.97% |
        | **2분위** | 6,608 ~ 18,794 | -0.06% |
        | **1분위 (최대)** | 18,837억 초과 | -0.51% |
        """)

        st.info("💡 Target 기업의 시가총액에 맞는 Size Premium을 선택하세요.")

    # 한국공인회계사회 기업규모위험 프리미엄 연구결과 (2026.06.05).
    # gpcm_kr.SRP_TERTILE / SRP_QUINTILE 과 같은 값이어야 한다 — 임포트하면 국내
    # 앱의 사이드바가 실행되므로 값을 복사해 두고, 테스트로 동일성을 고정한다.
    size_premium_options = {
        "3분위 - Micro (4.02%): 296~2,583억": 0.0402,
        "3분위 - Low (1.19%): 2,585~8,671억": 0.0119,
        "3분위 - Mid (-0.45%): 8,679억 초과": -0.0045,
        "5분위 - 5분위/최소 (4.86%): 296~1,759억": 0.0486,
        "5분위 - 4분위 (2.67%): 1,760~3,135억": 0.0267,
        "5분위 - 3분위 (0.97%): 3,142~6,600억": 0.0097,
        "5분위 - 2분위 (-0.06%): 6,608~18,794억": -0.0006,
        "5분위 - 1분위/최대 (-0.51%): 18,837억 초과": -0.0051,
